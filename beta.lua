...
Tabs.Macro:AddSection("AUTO PICK UPGRADE")
Tabs.Macro:AddToggle("ExpeditionAutoCards", {Title = "Auto Pick Upgrade / Anvil", Default = ExpeditionAuto.autoCards}):OnChanged(function(value) ExpeditionAuto.autoCards = value; saveConfig() end)
Tabs.Macro:AddDropdown("ExpeditionAutoCardsPriority", {Title = "Upgrade Priority", Values = upgradeOptions, Multi = true, Default = ExpeditionAuto.upgradePriority}):OnChanged(function(value) ExpeditionAuto.upgradePriority = expeditionListFromDropdown(value); saveConfig() end)
Tabs.Macro:AddDropdown("ExpeditionAutoCardFallback", {Title = "Card Fallback", Values = {"First", "Random"}, Multi = false, Default = ExpeditionAuto.cardFallback}):OnChanged(function(value) ExpeditionAuto.cardFallback = value; saveConfig() end)
Tabs.Macro:AddSection("AUTO PICK ANVIL")
Tabs.Macro:AddParagraph({Title = "ANVIL STAT PRIORITY", Content = "When Anvil options appear, it picks the first stat in this selected priority list. If none appear, it uses the normal card fallback."})
Tabs.Macro:AddDropdown("ExpeditionAutoStats", {Title = "Choose Anvil Stats", Values = statOptions, Multi = true, Default = ExpeditionAuto.statPriority}):OnChanged(function(value) ExpeditionAuto.statPriority = expeditionListFromDropdown(value); saveConfig() end)
Tabs.Macro:AddToggle("ExpeditionAutoAnvil", {Title = "Buy / Use Stat Anvil", Default = ExpeditionAuto.buyAnvil}):OnChanged(function(value) ExpeditionAuto.buyAnvil = value; ExpeditionAuto.autoUseAnvil = value; saveConfig() end)
Tabs.Macro:AddSection("AUTO SHOP - TRAIT TOMES")
Tabs.Macro:AddParagraph({Title = "SELECT TOME TRAITS TO BUY", Content = "A Tome is bought only when its trait matches the selected list and the matching unit type is already placed."})
...
tomeTraitParagraph = Tabs.Macro:AddParagraph({Title = "SELECTED TOME TRAITS", Content = expeditionTomeTraitSummary()})
Tabs.Macro:AddToggle("ExpeditionAutoShop", {Title = "Auto Buy Checkpoint Shop", Default = ExpeditionAuto.autoShop}):OnChanged(function(value) ExpeditionAuto.autoShop = value; saveConfig() end)
Tabs.Macro:AddToggle("ExpeditionAutoTome", {Title = "Buy / Use Selected Trait Tomes", Default = ExpeditionAuto.buyTome}):OnChanged(function(value) ExpeditionAuto.buyTome = value; ExpeditionAuto.autoUseTome = value; saveConfig() end)
Tabs.Macro:AddToggle("ExpeditionAutoRepair", {Title = "Auto Repair Exact Missing HP", Default = ExpeditionAuto.buyRepair}):OnChanged(function(value) ExpeditionAuto.buyRepair = value; saveConfig() end)
Tabs.Macro:AddToggle("ExpeditionAutoOrbs", {Title = "Auto Pickup Orbs", Default = ExpeditionAuto.autoOrbs}):OnChanged(function(value) ExpeditionAuto.autoOrbs = value; saveConfig() end)
...
Tabs.Macro:AddToggle("ExpeditionAutoContinue", {Title = "Auto Continue", Default = ExpeditionAuto.autoContinue}):OnChanged(function(value) ExpeditionAuto.autoContinue = value; saveConfig() end)
Tabs.Macro:AddInput("ExpeditionAutoContinueDelay", {Title = "Continue Delay", Default = tostring(ExpeditionAuto.continueDelay), Numeric = true, Finished = true, Callback = function(value) ExpeditionAuto.continueDelay = math.max(0, tonumber(value) or 3); saveConfig() end})
Tabs.Macro:AddSection("EXPEDITION HIRED UNIT POSITIONS")
Tabs.Macro:AddToggle("ExpeditionAutoHire", {Title = "Auto Hire EVO Helpers", Default = ExpeditionAuto.autoHire}):OnChanged(function(value) ExpeditionAuto.autoHire = value; saveConfig() end)
for index = 1, 10 do
